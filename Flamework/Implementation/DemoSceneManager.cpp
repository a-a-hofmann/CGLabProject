...
/*
    // TODO: implement solar system
    // sun
    pushModelMatrix();
    transformModelMatrix(vmml::create_translation(vmml::vec3f(0, 0, 0)));
    drawSphere();
      // planet 1
      pushModelMatrix();
      transformModelMatrix(vmml::create_rotation(angle, vmml::vec3f::UNIT_Z));
      transformModelMatrix(vmml::create_translation(vmml::vec3f(2, 0, 0)));
      transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
      drawSphere();
        // moon 1
        pushModelMatrix();
        transformModelMatrix(vmml::create_rotation(angle, vmml::vec3f::UNIT_Z));
    ...
    // planet 2
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.1f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(4, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    // moon 2
    pushModelMatrix();
    ...
    // planet 3
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.2f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(6, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    // moon 3
    pushModelMatrix();
    ...
    // planet 4
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.3f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(8, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    popModelMatrix();
    // planet 5
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.4f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(10, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    popModelMatrix();
    // planet 6
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.5f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(12, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    popModelMatrix();
    // planet 7
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.6f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(14, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    popModelMatrix();
    // planet 8
    pushModelMatrix();
    transformModelMatrix(vmml::create_rotation(.7f+angle, vmml::vec3f::UNIT_Z));
    transformModelMatrix(vmml::create_translation(vmml::vec3f(16, 0, 0)));
    transformModelMatrix(vmml::create_scaling(vmml::vec3f(.3, .3, .3)));
    drawSphere();
    popModelMatrix();
    popModelMatrix();
